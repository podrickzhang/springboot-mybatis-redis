...
@CacheConfig(cacheNames = "cacheName", keyGenerator = "myKeyGenerator")
...
public class UserService {
   ...
   //那保存对象进数据库的时候，就没必要放到缓存了
	//必须要有返回值，否则没数据放到缓存中
	@CachePut(value = "key", keyGenerator = "myKeyGenerator")
	...
	@Cacheable(value = "key",keyGenerator = "myKeyGenerator")
